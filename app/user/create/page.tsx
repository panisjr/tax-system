    ...
    <div className="w-full">
      ...
      <div className="mb-6 flex items-start justify-between gap-4">
        ...
        <div className="flex items-center gap-2">
          <Link
            href="/user"
            className="inline-flex items-center gap-2 rounded-md border border-gray-200 bg-white px-3 py-2 text-sm font-medium text-slate-600 hover:bg-gray-50"
          >
            <X className="h-4 w-4" />
            Cancel
          </Link>
          ...
          <button
            type="button"
            className="inline-flex items-center gap-2 rounded-md bg-[#0F172A] px-4 py-2 text-sm font-medium text-white hover:bg-slate-800"
            onClick={() => {
              // design-only
            }}
          >
            ...
            <div className="mt-4">
              ...
              <div className="mt-4">
                ...
                <Accordion type="single" collapsible className="mt-1">
                  ...
                  >
                    <AccordionTrigger className="px-3 py-2 text-sm text-slate-900 hover:no-underline">
